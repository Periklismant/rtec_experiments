...
handleApplication(Prolog, toydeadlinescsv, InputMode, LogFile, ResultsFile, WM, Step, StartReasoningTime, EndReasoningTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ForgetThreshold, DynamicGroundingThreshold, ClockTick, SDEBatch) :- 
	(Prolog=yap, 
...
handleApplication(Prolog, netbillBig, InputMode, LogFile, ResultsFile, WM, Step, StartReasoningTime, EndReasoningTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ForgetThreshold, DynamicGroundingThreshold, ClockTick, SDEBatch) :-
	(Prolog=yap,
	 ...
	 ResultsFile = '../examples/negotiation/experiments/execution log files/log-YAP-netbill-big-10-10-recognised-intervals.txt'
	 ;
	 Prolog=swi,
	 LogFile = '../examples/negotiation/experiments/execution log files/log-SWI-netbill-big-10-10.txt',
	 ResultsFile = '../examples/negotiation/experiments/execution log files/log-SWI-netbill-big-10-10-recognised-intervals.txt'
	),
	WM = 10,
	Step = 10, 
	AgentNo = 4000,
...
handleApplication(Prolog, netbillBigDG, InputMode, LogFile, ResultsFile, WM, Step, StartReasoningTime, EndReasoningTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ForgetThreshold, DynamicGroundingThreshold, ClockTick, SDEBatch) :-
	(Prolog=yap,
	 LogFile = '../examples/negotiation/experiments/execution log files/log-YAP-netbill-big-dg-10-10.txt',
	 ResultsFile = '../examples/negotiation/experiments/execution log files/log-YAP-netbill-big-dg-10-10-recognised-intervals-dg.txt'
	 ;
	 Prolog=swi,
	 LogFile = '../examples/negotiation/experiments/execution log files/log-SWI-netbill-big-dg-10-10.txt',
	 ResultsFile = '../examples/negotiation/experiments/execution log files/log-SWI-netbill-big-dg-10-10-recognised-intervals-dg.txt'
	),
	WM = 10,
	Step = 10, 
	AgentNo = 4000,
...
handleApplication(Prolog, votingBig, InputMode, LogFile, ResultsFile, WM, Step, StartReasoningTime, EndReasoningTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ForgetThreshold, DynamicGroundingThreshold, ClockTick, SDEBatch) :-
	(Prolog=yap,
	 ...
	 ResultsFile = '../examples/voting/experiments/execution log files/log-YAP-voting-big-10-10-recognised-intervals.txt'
	 ;
	 Prolog=swi,
	 LogFile = '../examples/voting/experiments/execution log files/log-SWI-voting-big-10-10.txt',
	 ResultsFile = '../examples/voting/experiments/execution log files/log-SWI-voting-big-10-10-recognised-intervals.txt'
	),
	WM = 10,
	Step = 10, 
	AgentNo = 4000,
...
handleApplication(Prolog, brest-critical, InputMode, LogFile, ResultsFile, WM, Step, StartReasoningTime, EndReasoningTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ForgetThreshold, DynamicGroundingThreshold, ClockTick, _SDEBatch) :-
	(Prolog=yap,
 	 LogFile = '../examples/Maritime-Monitoring/Brest/experiments/execution log files/log-Brest-critical-yap-20000-simpleContinuous-0.5.txt',
	 ResultsFile = '../examples/Maritime-Monitoring/Brest/experiments/execution log files/recognised_CEs-simpleContinuous-20000-0.5.txt'
	 ;
	 Prolog=swi,
	...
	InputMode = csv(['../examples/Maritime-Monitoring/Brest/experiments/data/dynamic/preprocessed_dataset_RTEC_critical_nd_20000_simpleContinuous_0.5.csv']),
...
%%%%%%%%%%%%%%%%%%%%%%%% Maritime-Europe (IMIS) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%% critical points

handleApplication(Prolog, europeIMIS-critical, InputMode, LogFile, ResultsFile, WM, Step, StartReasoningTime, EndReasoningTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ForgetThreshold, DynamicGroundingThreshold, ClockTick, _SDEBatch) :-
	(Prolog=yap,
	 LogFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-yap-critical-1day-1day.txt',
	 ResultsFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-yap-critical-1day-1day-recognised-intervals-yap-critical.txt'
	 ;
	 Prolog=swi,
	 LogFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-SWI-critical-1day-1day.txt',
	 ResultsFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-SWI-critical-1day-1day-recognised-intervals-SWI-critical.txt'
	),
	WM = 86400,
	Step = 86400, 
	% start of the dataset:
...
handleApplication(Prolog, europeIMIS-enriched, InputMode, LogFile, ResultsFile, WM, Step, StartReasoningTime, EndReasoningTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ForgetThreshold, DynamicGroundingThreshold, ClockTick, _SDEBatch) :-
	(Prolog=yap,
	 LogFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-yap-enriched-1day-1day.txt',
	 ResultsFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-yap-enriched-1day-1day-recognised-intervals-yap-critical.txt'
	 ;
	 Prolog=swi,
	 LogFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-SWI-enriched-1day-1day.txt',
	 ResultsFile = '../examples/Maritime-Monitoring/Europe-IMIS/experiments/execution log files/log-IMIS-SWI-enriched-1day-1day-recognised-intervals-SWI-critical.txt'
	),
	WM = 86400,
	Step = 86400, 
	% start of the dataset:
	...
	consult('../src/timeoutTreatment.prolog'),
	% load the dynamic data:
	InputMode = csv(['../examples/Maritime-Monitoring/Europe-IMIS/experiments/data/dynamic/preprocessed_dataset_RTEC_imis_enriched_nd.csv']),
	%%% Important: instruct the execution script that the recognitions on this dataset will be treated as the ground truth
	assert( datasetType(ground_truth) ),
	% load the static data
	consult('../examples/Maritime-Monitoring/Europe-IMIS/experiments/data/static/loadStaticData.prolog'), !.
