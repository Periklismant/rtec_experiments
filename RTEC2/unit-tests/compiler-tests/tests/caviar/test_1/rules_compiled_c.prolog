...
initiatedAt(person(_131566)=true, _131593, _131549, _131595) :-
     user:happensAt(start(walking(_131566)=true),_131549),
     \+user:happensAt(disappear(_131566),_131549).

initiatedAt(person(_131566)=true, _131593, _131549, _131595) :-
     user:happensAt(start(running(_131566)=true),_131549),
     \+user:happensAt(disappear(_131566),_131549).

initiatedAt(person(_131566)=true, _131593, _131549, _131595) :-
     user:happensAt(start(active(_131566)=true),_131549),
     \+user:happensAt(disappear(_131566),_131549).

initiatedAt(person(_131566)=true, _131593, _131549, _131595) :-
     user:happensAt(start(abrupt(_131566)=true),_131549),
     \+user:happensAt(disappear(_131566),_131549).
...
initiatedAt(meeting(_131566,_131567)=true, _131608, _131549, _131610) :-
     user:happensAt(start(greeting1(_131566,_131567)=true),_131549),
     \+user:happensAt(disappear(_131566),_131549),
     \+user:happensAt(disappear(_131567),_131549).

initiatedAt(meeting(_131566,_131567)=true, _131608, _131549, _131610) :-
     user:happensAt(start(greeting2(_131566,_131567)=true),_131549),
     \+user:happensAt(disappear(_131566),_131549),
     \+user:happensAt(disappear(_131567),_131549).
...
initiatedAt(meeting(_131566,_131567)=false, _131581, _131549, _131583) :-
     user:happensAt(start(running(_131567)=true),_131549).

initiatedAt(meeting(_131566,_131567)=false, _131581, _131549, _131583) :-
     user:happensAt(start(abrupt(_131566)=true),_131549).

initiatedAt(meeting(_131566,_131567)=false, _131581, _131549, _131583) :-
     user:happensAt(start(abrupt(_131567)=true),_131549).

initiatedAt(meeting(_131566,_131567)=false, _131583, _131549, _131585) :-
     user:happensAt(start(close(_131566,_131567,34)=false),_131549).
