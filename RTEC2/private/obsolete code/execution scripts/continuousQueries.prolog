...
% eg: continuousER(yap, netbillSmall).
% eg: continuousER(yap, netbillBig).
% eg: continuousER(yap, votingSmall).
% eg: continuousER(yap, votingBig).

% eg: continuousER(swi, toy).
% eg: continuousER(swi, caviar).
% eg: continuousER(swi, ctm).
% eg: continuousER(swi, netbillSmall).
% eg: continuousER(swi, netbillBig).
% eg: continuousER(swi, votingSmall).
% eg: continuousER(swi, votingBig).
...
continuousER(Prolog, App) :-
  ...
  % StreamOrderFlag (ordered or unordered), DynamicGroundingFlag (dynamicgrounding or nodynamicgrounding),
  ...
  handleApplication(Prolog, App, LogFile, WM, Step, LastTime, StreamOrderFlag, DynamicGroundingFlag, PreprocessingFlag, ClockTick, SDEBatch),
  format("                                                                 
