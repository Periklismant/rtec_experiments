...
simpleFluent(fishingTripStatus(_)=null).         outputEntity(fishingTripStatus(_)=null).         index(fishingTripStatus(Vessel)=null, Vessel).
simpleFluent(fishingTripStatus(_)=aomni).         outputEntity(fishingTripStatus(_)=aomni).         index(fishingTripStatus(Vessel)=aomni, Vessel).
simpleFluent(fishingTripStatus(_)=aomi).         outputEntity(fishingTripStatus(_)=aomi).         index(fishingTripStatus(Vessel)=aomi, Vessel).

simpleFluent(fishingTripStatus(_)=underWay).         outputEntity(fishingTripStatus(_)=underWay).         index(fishingTripStatus(Vessel)=underWay, Vessel).
simpleFluent(fishingTripStatus(_)=trawling).         outputEntity(fishingTripStatus(_)=trawling).         index(fishingTripStatus(Vessel)=trawling, Vessel).
simpleFluent(fishingTripStatus(_)=interrupted).         outputEntity(fishingTripStatus(_)=interrupted).         index(fishingTripStatus(Vessel)=interrupted, Vessel).
...
cyclic(fishingTripStatus(_)=null).
cyclic(fishingTripStatus(_)=aomi).
cyclic(fishingTripStatus(_)=aomni).
cyclic(fishingTripStatus(_)=underWay).
cyclic(fishingTripStatus(_)=trawling).
cyclic(fishingTripStatus(_)=interrupted).
...
grounding(fishingTripStatus(Vessel)=null)                          		:- vessel(Vessel), vesselType(Vessel, fishing).
dgrounded(fishingTripStatus(Vessel)=null, vessel(Vessel)).
grounding(fishingTripStatus(Vessel)=aomni)                          		:- vessel(Vessel), vesselType(Vessel, fishing).
dgrounded(fishingTripStatus(Vessel)=aomni, vessel(Vessel)).
grounding(fishingTripStatus(Vessel)=aomi)                          		:- vessel(Vessel), vesselType(Vessel, fishing).
dgrounded(fishingTripStatus(Vessel)=aomi, vessel(Vessel)).
grounding(fishingTripStatus(Vessel)=underWay)                          		:- vessel(Vessel), vesselType(Vessel, fishing).
dgrounded(fishingTripStatus(Vessel)=underWay, vessel(Vessel)).
grounding(fishingTripStatus(Vessel)=trawling)                          		:- vessel(Vessel), vesselType(Vessel, fishing).
dgrounded(fishingTripStatus(Vessel)=trawling, vessel(Vessel)).
grounding(fishingTripStatus(Vessel)=interrupted)                          		:- vessel(Vessel), vesselType(Vessel, fishing).
dgrounded(fishingTripStatus(Vessel)=interrupted, vessel(Vessel)).
...
cachingOrder(fishingTripStatus(_)=null).
cachingOrder(fishingTripStatus(_)=aomni).
cachingOrder(fishingTripStatus(_)=aomi).
cachingOrder(fishingTripStatus(_)=underWay).
cachingOrder(fishingTripStatus(_)=trawling).
cachingOrder(fishingTripStatus(_)=interrupted).
