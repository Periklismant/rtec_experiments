...
maxDurationUE(sarMovement(Vessel)=true,sarMovement(Vessel)=false,SarMovementDeadline) :- 
    nb_getval(sarMovementDeadline, SarMovementDeadline), grounding(sarMovement(Vessel)=true).

maxDurationUE(trawlingMovement(Vessel)=true,trawlingMovement(Vessel)=false,TrawlingMovementDeadline) :-  
    nb_getval(trawlingMovementDeadline, TrawlingMovementDeadline), grounding(trawlingMovement(Vessel)=true).
