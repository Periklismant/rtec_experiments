...
oneIsTug(Vessel1,Vessel2):-vesselType(Vessel1,tug).
oneIsTug(Vessel1,Vessel2):-vesselType(Vessel2,tug).

twoAreTugs(Vessel1,Vessel2):-vesselType(Vessel1,tug),vesselType(Vessel2,tug).

oneIsPilot(Vessel1,Vessel2):-vesselType(Vessel1,pilotvessel).
oneIsPilot(Vessel1,Vessel2):-vesselType(Vessel2,pilotvessel).
