...
createNarrative(Start, End, AgentNo, Seed):-
	...
	openFile(AgentNo, End, Seed, WriteFileStream),
...
openFile(AgentNo, End, Seed, OpenFileStream):-
    number_atom(AgentNo, AgentNoAtom),
    number_atom(End, EndAtom),
    number_atom(Seed, SeedAtom),
	atom_concat('../csv/negotiation-', AgentNoAtom, FName1),
	atom_concat(FName1, '-', FName2),
	atom_concat(FName2, EndAtom, FName3),
	atom_concat(FName3, '-', FName4),
	atom_concat(FName4, SeedAtom, FName5),
	atom_concat(FName5, '.csv', FName),
