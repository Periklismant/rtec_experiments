...
initiatedAt(contract(_131139,_131140,_131141)=true, _131193, _131124, _131195) :-
     updateVariableTemp(number_of_contract_init_calls, 1),
     ...
     \+holdsAtCyclicNaive(suspended(_131139,merchant)=true,_131124),
     \+holdsAtCyclicNaive(suspended(_131140,consumer)=true,_131124),
     updateVariableTemp(number_of_contract_init_evaluations, 1).
...
initiatedAt(suspended(_131143,merchant)=true, _131124, _131125, _131126) :-
     ...
     holdsAtCyclicNaive(obl(send_goods(_131143,iServer,_131159))=true,_131125).
...
initiatedAt(suspended(_131143,consumer)=true, _131124, _131125, _131126) :-
     ...
     holdsAtCyclicNaive(obl(send_EPO(_131143,iServer,_131159))=true,_131125).
...
initiatedAt(suspended(Cons,consumer)=true, T1, T, T2) :-
     ...
     holdsAtCyclicNaive(obl(send_EPO(Cons,iServer,GD))=true, T).  
...
initDeadlines(Mult) :- 
	QuoteDeadline is Mult * 5,
	nb_setval(quoteDeadline, QuoteDeadline),
	PerDeadline is Mult * 10,
	nb_setval(perDeadline, PerDeadline),
	SuspendedDeadline is Mult * 3,
	nb_setval(suspendedDeadline, SuspendedDeadline),
	ContractDeadline is Mult * 5,
	nb_setval(contractDeadline, ContractDeadline).

maxDurationUE(quote(_131176,_131177,_131178)=true,quote(_131176,_131177,_131178)=false, QuoteDeadline) :- 
     nb_getval(quoteDeadline, QuoteDeadline), grounding(quote(_131176,_131177,_131178)=true).

maxDurationUE(per(present_quote(_131178,_131179))=false,per(present_quote(_131178,_131179))=true,PerDeadline) :-
     nb_getval(perDeadline, PerDeadline), grounding(per(present_quote(_131178,_131179))=false).

maxDurationUE(suspended(_131176,_131177)=true,suspended(_131176,_131177)=false,SuspendedDeadline) :- 
     nb_getval(suspendedDeadline, SuspendedDeadline), grounding(suspended(_131176,_131177)=true).

maxDuration(contract(_131176,_131177,_131178)=true,contract(_131176,_131177,_131178)=false,ContractDeadline) :- 
     nb_getval(contractDeadline, ContractDeadline), grounding(contract(_131176,_131177,_131178)=true).
