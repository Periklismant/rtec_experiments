test:-
	update([happens(presentQuote(10,10,book),1),happens(presentQuote(0,4,book),1),happens(presentQuote(10,8,book),1),happens(presentQuote(10,14,book),1),happens(presentQuote(0,10,book),1),happens(presentQuote(10,4,book),1),happens(acceptQuote(10,10,book),6),happens(presentQuote(0,8,book),11)]),
	update([happens(presentQuote(0,10,book),11),happens(presentQuote(10,8,book),11),happens(acceptQuote(10,10,book),16),happens(presentQuote(0,14,book),21)]),
	update([happens(presentQuote(10,4,book),21),happens(presentQuote(10,14,book),31)]),
	update([happens(presentQuote(0,14,book),31),happens(presentQuote(10,10,book),31),happens(acceptQuote(10,10,book),36),happens(presentQuote(10,14,book),41)]),
	update([happens(presentQuote(0,8,book),41),happens(presentQuote(10,10,book),41),happens(presentQuote(0,14,book),41),happens(presentQuote(10,4,book),41),happens(acceptQuote(10,10,book),46)]),
	status.
