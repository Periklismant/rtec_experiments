test:-
	update([happens(presentQuote(0,13,book),1),happens(presentQuote(10,8,book),1),happens(presentQuote(10,13,book),1),happens(presentQuote(0,1,book),1),happens(presentQuote(10,11,book),1),happens(presentQuote(0,7,book),1),happens(presentQuote(0,2,book),1),happens(presentQuote(0,5,book),1),happens(presentQuote(0,11,book),1),happens(presentQuote(10,5,book),11),happens(presentQuote(0,14,book),11),happens(presentQuote(0,7,book),11),happens(presentQuote(0,2,book),11),happens(presentQuote(0,5,book),11),happens(presentQuote(10,8,book),11),happens(presentQuote(0,10,book),11),happens(presentQuote(10,4,book),11),happens(presentQuote(10,8,book),21),happens(presentQuote(0,11,book),21),happens(presentQuote(10,13,book),21),happens(presentQuote(10,11,book),21),happens(presentQuote(0,5,book),21),happens(presentQuote(10,1,book),21),happens(presentQuote(0,7,book),21),happens(presentQuote(0,4,book),21),happens(presentQuote(0,4,book),31),happens(presentQuote(0,8,book),31),happens(presentQuote(10,10,book),31),happens(presentQuote(0,7,book),31),happens(presentQuote(0,2,book),31),happens(presentQuote(10,14,book),31),happens(presentQuote(10,4,book),31),happens(presentQuote(0,11,book),31),happens(presentQuote(0,14,book),31),happens(acceptQuote(10,10,book),36),happens(presentQuote(10,7,book),41),happens(presentQuote(10,13,book),41),happens(presentQuote(0,13,book),41),happens(presentQuote(10,8,book),41),happens(presentQuote(10,1,book),41),happens(presentQuote(10,2,book),41),happens(presentQuote(10,5,book),41),happens(presentQuote(0,8,book),41),happens(presentQuote(10,4,book),41)]),
	status.
