...
[ ! -z $compile ] && $compile_command && ( [ $? == 0 ] && echo "Successful compilation! Compiled event description in: ${event_description%/*}/compiled_rules.prolog" || exit_func $? ) 
